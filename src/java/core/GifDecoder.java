...
public class GifDecoder {
    ...
    // pixel aspect ratio      (yes it is used!) 
    ...
    private byte[] currentDataBlock = new byte[256];  // current data block 
    ...
    public static class GifFrame {
        ...
        public GifFrame(BufferedImage bufferedImage, int delay) {
    ...
    protected void readNetscapeExt() {
        do {
            ...
            if (currentDataBlock[0] == 1) {
                ...
                int b1 = ((int) currentDataBlock[1]) & 0xff;
                int b2 = ((int) currentDataBlock[2]) & 0xff;
                loopCount = (b2 << 8) | b1;
            }
    ...
    protected void setPixels() {
        ...
        int[] dest = ((DataBufferInt) currentBufImg.getRaster().getDataBuffer()).getData();
        ...
        if (lastDispose > 0) {
            ...
            if (prevBufImg != null) {
                int[] prev = ((DataBufferInt) prevBufImg.getRaster().getDataBuffer()).getData();
                System.arraycopy(prev, 0, dest, 0, width * height);  // copy pixels 

                if (lastDispose == 2) {
                    // fill last image rect area with background color 
                    Graphics2D g = currentBufImg.createGraphics();
                    Color c = null;
                    if (transparency) {
