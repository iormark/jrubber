$(document).ready(function() {
    ...
    $(document).on('change', '#add__post input[name="title"], #add__post input[name="tags"], #add__post input[name="age"], #add__post input[name="profanity"]', function(e) {
    ...
    $("#upload").click(function() {
        ...
        //log($('#add__post input[name="age"]:checked').val());
        //return;
    ...
    function createPost() {
        ...
        if ((updateCount === itemCount) || create) {
            ...
            $.post('/svc/FileUpload', {
                ...
                title: $("#add__post input[name='title']").val(),
                tags: $("#add__post input[name='tags']").val(),
                age: $("#add__post input[name='age']:checked").val(),
                profanity: $("#add__post input[name='profanity']:checked").val(),
                key: $("#add__post input[name='key']").val(),
